    ...
    <div class="box absolute inset-x-0 mx-5 h-full rounded-xl before:absolute before:inset-x-4 before:top-0 before:z-[-1] before:mx-auto before:mt-3 before:h-full before:rounded-lg before:border before:border-slate-200 before:bg-slate-50 before:shadow-sm before:content-[''] before:dark:border-darkmode-500/60 before:dark:bg-darkmode-600/70">
        <div class="flex h-full w-full items-center px-5">
                        ...
                        <div class="hidden group-[.global-search--show-result]:block">
                                ...
                                <div class="mt-3.5 flex flex-col gap-1">
                                    <a class="flex items-center gap-2.5 rounded-md border border-transparent p-1 hover:border-slate-100 hover:bg-slate-50/80" href="#">
                                        <div class="image-fit zoom-in box h-6 w-6 overflow-hidden rounded-full border-2 border-slate-200/70">
                                            <img src="{{ asset('theme/dist/images/users/user5-50x50.jpg') }}" alt="Tailwise - Admin Dashboard Template">
                                        </div>
                                    ...
                                    <a class="flex items-center gap-2.5 rounded-md border border-transparent p-1 hover:border-slate-100 hover:bg-slate-50/80" href="#">
                                        <div class="image-fit zoom-in box h-6 w-6 overflow-hidden rounded-full border-2 border-slate-200/70">
                                            <img src="{{ asset('theme/dist/images/users/user7-50x50.jpg') }}" alt="Tailwise - Admin Dashboard Template">
                                        </div>
                                        <div class="truncate font-medium">
                                            Johnny Depp
                                        </div>
                                    ...
                                    <a class="flex items-center gap-2.5 rounded-md border border-transparent p-1 hover:border-slate-100 hover:bg-slate-50/80" href="#">
                                        <div class="image-fit zoom-in box h-6 w-6 overflow-hidden rounded-full border-2 border-slate-200/70">
                                            <img src="{{ asset('theme/dist/images/users/user8-50x50.jpg') }}" alt="Tailwise - Admin Dashboard Template">
                                        </div>
                                        <div class="truncate font-medium">
                                            Cate Blanchett
                                        </div>
                            ...
                            <div class="border-t border-dashed px-5 py-4">
                                ...
                                <div class="mt-3.5 flex flex-col gap-1">
                                    <a class="flex items-center gap-2.5 rounded-md border border-transparent p-1 hover:border-slate-100 hover:bg-slate-50/80" href="#">
                                        <div class="image-fit zoom-in box h-6 w-6 overflow-hidden rounded-full border-2 border-slate-200/70">
                                            <img src="{{ asset('theme/dist/images/products/product1-400x400.jpg') }}" alt="Tailwise - Admin Dashboard Template">
                                        </div>
                                        <div class="truncate font-medium">
                                            8-Cup Coffee Maker
                                        </div>
                                    ...
                                    <a class="flex items-center gap-2.5 rounded-md border border-transparent p-1 hover:border-slate-100 hover:bg-slate-50/80" href="#">
                                        <div class="image-fit zoom-in box h-6 w-6 overflow-hidden rounded-full border-2 border-slate-200/70">
                                            <img src="{{ asset('theme/dist/images/products/product9-400x400.jpg') }}" alt="Tailwise - Admin Dashboard Template">
                                        </div>
                                        <div class="truncate font-medium">
                                            8-Cup Coffee Maker
                                        </div>
                                    ...
                                    <a class="flex items-center gap-2.5 rounded-md border border-transparent p-1 hover:border-slate-100 hover:bg-slate-50/80" href="#">
                                        <div class="image-fit zoom-in box h-6 w-6 overflow-hidden rounded-full border-2 border-slate-200/70">
                                            <img src="{{ asset('theme/dist/images/products/product6-400x400.jpg') }}" alt="Tailwise - Admin Dashboard Template">
                                        </div>
                                        <div class="truncate font-medium">
            ...
            <div class="flex flex-1 items-center">
                ...
                <div data-tw-merge="" data-tw-placement="bottom-end" class="dropdown relative ml-5"><button data-tw-toggle="dropdown" aria-expanded="false" class="cursor-pointer image-fit h-[36px] w-[36px] overflow-hidden rounded-full border-[3px] border-slate-200/70"><img src="{{ asset('theme/dist/images/users/user3-50x50.jpg') }}" alt="Tailwise - Admin Dashboard Template">
                    </button>
                    <div data-transition="" data-selector=".show" data-enter="transition-all ease-linear duration-150" data-enter-from="absolute !mt-5 invisible opacity-0 translate-y-1" data-enter-to="!mt-1 visible opacity-100 translate-y-0" data-leave="transition-all ease-linear duration-150" data-leave-from="!mt-1 visible opacity-100 translate-y-0" data-leave-to="absolute !mt-5 invisible opacity-0 translate-y-1" class="dropdown-menu absolute z-[9999] hidden">
                                ...
                                <a class="flex items-center rounded-xl px-3 py-2.5 hover:bg-slate-100/80" href="#">
                                    <div>
                                        <div class="image-fit h-11 w-11 overflow-hidden rounded-full border-2 border-slate-200/70">
                                            <img src="{{ asset('theme/dist/images/users/user3-50x50.jpg') }}" alt="Tailwise - Admin Dashboard Template">
                                        </div>
                                    </div>
                                    <div class="sm:ml-5">
                                        ...
                                        <div class="my-3.5 w-40 rounded-[0.6rem] border bg-slate-50/80 p-1 sm:w-56">
                                            <div class="grid grid-cols-3 overflow-hidden rounded-[0.6rem]">
                                                <div class="image-fit h-12 cursor-pointer overflow-hidden border border-slate-100 saturate-[.6] hover:saturate-100 sm:h-16">
                                                    <img src="{{ asset('theme/dist/images/projects/project4-400x400.jpg') }}" alt="Tailwise - Admin Dashboard Template">
                                                </div>
                                                <div class="image-fit h-12 cursor-pointer overflow-hidden border border-slate-100 saturate-[.6] hover:saturate-100 sm:h-16">
                                                    <img src="{{ asset('theme/dist/images/projects/project1-400x400.jpg') }}" alt="Tailwise - Admin Dashboard Template">
                                                </div>
                                                <div class="image-fit h-12 cursor-pointer overflow-hidden border border-slate-100 saturate-[.6] hover:saturate-100 sm:h-16">
                                                    <img src="{{ asset('theme/dist/images/projects/project7-400x400.jpg') }}" alt="Tailwise - Admin Dashboard Template">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mt-1.5 text-xs text-slate-500">
                                    ...
                                    <div class="sm:ml-5">
                                        ...
                                        <div class="my-3.5 w-40 rounded-[0.6rem] border bg-slate-50/80 p-1 sm:w-56">
                                            <div class="grid grid-cols-3 overflow-hidden rounded-[0.6rem]">
                                                ...
                                                <div class="image-fit h-12 cursor-pointer overflow-hidden border border-slate-100 saturate-[.6] hover:saturate-100 sm:h-16">
                                                    <img src="{{ asset('theme/dist/images/projects/project10-400x400.jpg') }}" alt="Tailwise - Admin Dashboard Template">
                                                </div>
                                                <div class="image-fit h-12 cursor-pointer overflow-hidden border border-slate-100 saturate-[.6] hover:saturate-100 sm:h-16">
                                                    <img src="{{ asset('theme/dist/images/projects/project5-400x400.jpg') }}" alt="Tailwise - Admin Dashboard Template">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mt-1.5 text-xs text-slate-500">
                                ...
                                <a class="flex items-center rounded-xl px-3 py-2.5 hover:bg-slate-100/80" href="#">
                                    ...
                                    <div class="sm:ml-5">
                                        ...
                                        <div class="my-3.5 w-40 rounded-[0.6rem] border bg-slate-50/80 p-1 sm:w-56">
                                            <div class="grid grid-cols-3 overflow-hidden rounded-[0.6rem]">
                                                <div class="image-fit h-12 cursor-pointer overflow-hidden border border-slate-100 saturate-[.6] hover:saturate-100 sm:h-16">
                                                    <img src="{{ asset('theme/dist/images/projects/project8-400x400.jpg') }}" alt="Tailwise - Admin Dashboard Template">
                                                </div>
                                                <div class="image-fit h-12 cursor-pointer overflow-hidden border border-slate-100 saturate-[.6] hover:saturate-100 sm:h-16">
                                                    <img src="{{ asset('theme/dist/images/projects/project9-400x400.jpg') }}" alt="Tailwise - Admin Dashboard Template">
                                                </div>
                                                <div class="image-fit h-12 cursor-pointer overflow-hidden border border-slate-100 saturate-[.6] hover:saturate-100 sm:h-16">
                                                    <img src="{{ asset('theme/dist/images/projects/project4-400x400.jpg') }}" alt="Tailwise - Admin Dashboard Template">
                                                </div>
                                ...
                                <a class="flex items-center rounded-xl px-3 py-2.5 hover:bg-slate-100/80" href="#">
                                    ...
                                    <div class="sm:ml-5">
                                        ...
                                        <div class="my-3.5 w-40 rounded-[0.6rem] border bg-slate-50/80 p-1 sm:w-56">
                                            <div class="grid grid-cols-3 overflow-hidden rounded-[0.6rem]">
                                                <div class="image-fit h-12 cursor-pointer overflow-hidden border border-slate-100 saturate-[.6] hover:saturate-100 sm:h-16">
                                                    <img src="{{ asset('theme/dist/images/projects/project6-400x400.jpg') }}" alt="Tailwise - Admin Dashboard Template">
                                                </div>
                                                <div class="image-fit h-12 cursor-pointer overflow-hidden border border-slate-100 saturate-[.6] hover:saturate-100 sm:h-16">
                                                    <img src="{{ asset('theme/dist/images/projects/project10-400x400.jpg') }}" alt="Tailwise - Admin Dashboard Template">
                                                </div>
                                ...
                                <a class="flex items-center rounded-xl px-3 py-2.5 hover:bg-slate-100/80" href="#">
                                    ...
                                    <div class="sm:ml-5">
                                        ...
                                        <div class="my-3.5 w-40 rounded-[0.6rem] border bg-slate-50/80 p-1 sm:w-56">
                                            <div class="grid grid-cols-3 overflow-hidden rounded-[0.6rem]">
                                                <div class="image-fit h-12 cursor-pointer overflow-hidden border border-slate-100 saturate-[.6] hover:saturate-100 sm:h-16">
                                                    <img src="{{ asset('theme/dist/images/projects/project2-400x400.jpg') }}" alt="Tailwise - Admin Dashboard Template">
                                                </div>
                                                <div class="image-fit h-12 cursor-pointer overflow-hidden border border-slate-100 saturate-[.6] hover:saturate-100 sm:h-16">
                                                    <img src="{{ asset('theme/dist/images/projects/project2-400x400.jpg') }}" alt="Tailwise - Admin Dashboard Template">
                                                </div>
                        ...
                        <div class="flex flex-col gap-1.5">
                            <div class="flex cursor-pointer items-center rounded-lg px-2.5 py-1 hover:bg-slate-100">
                                <div class="image-fit h-11 w-11 overflow-hidden rounded-full border-[3px] border-slate-200/70">
                                    <img src="{{ asset('theme/dist/images/users/user10-50x50.jpg') }}" alt="Tailwise - Admin Dashboard Template">
                                </div>
                                <div class="ml-3.5">
                            ...
                            <div class="flex cursor-pointer items-center rounded-lg px-2.5 py-1 hover:bg-slate-100">
                                <div class="image-fit h-11 w-11 overflow-hidden rounded-full border-[3px] border-slate-200/70">
                                    <img src="{{ asset('theme/dist/images/users/user1-50x50.jpg') }}" alt="Tailwise - Admin Dashboard Template">
                                </div>
                                <div class="ml-3.5">
                            ...
                            <div class="flex cursor-pointer items-center rounded-lg px-2.5 py-1 hover:bg-slate-100">
                                <div class="image-fit h-11 w-11 overflow-hidden rounded-full border-[3px] border-slate-200/70">
                                    <img src="{{ asset('theme/dist/images/users/user2-50x50.jpg') }}" alt="Tailwise - Admin Dashboard Template">
                                </div>
                                <div class="ml-3.5">
